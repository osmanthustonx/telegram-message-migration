...
```
CLI Layer (commander) → Orchestrator → Domain Services (Auth, Dialog, Group, Migration, RealtimeSync)
                                     → Infrastructure Services (Session, RateLimiter, Config, Progress, Log, Report)
```
